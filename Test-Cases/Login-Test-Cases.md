...
| TC_LOGIN_003 | Login with invalid username            | User account exists      | Enter invalid username and valid password. Click Login. | invalid_user / valid_password | Appropriate error message should be displayed.                         |
